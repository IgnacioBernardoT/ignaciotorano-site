...
# Fetches Google Places photos for every park in custom_parks.js
# and writes custom_park_photos.js. Takes ~2 minutes.
#
# HOW TO RUN:
#   cd C:\Users\ibtor\OneDrive\Documents\GitHub\ignaciotorano-site
#   set GOOGLE_API_KEY=AIzaSyAIPD9lbvJUfS7jTRrWeYNVejS5oOrYsOM
#   set PHOTO_KEY=AIzaSyCF9AyACywBdfes3baGyNgzaTTtRxCdLZ4
#   python fetch_custom_park_photos.py
